...
%% 
%%     $Id: exdl_keyboard.hrl,v 1.1 2004/03/30 07:50:46 bjorng Exp $
%%

%%%----------------------------------------------------------------------
%%% File    : exdl_keyboard.hrl
...
-define(SDLK_COMPOSE,      314). %%  Multi-key compose key
...
-define(SDLK_UNDO,         322). %%  Atari keyboard has Undo
