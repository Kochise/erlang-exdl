...
EXDL_API(egl_areTexturesResident)
{
  ...
  STACK_FMT_BEGIN()
    ...
    STACK_FMT_LPTR(GLboolean*, residences)
  STACK_FMT_END()

  FRAME_FMT_BEGIN()
    FRAME_FMT_DATA(GLboolean, exdl)
  FRAME_FMT_END()
...
EXDL_API(egl_getClipPlane)
{
  ...
  FRAME_FMT_BEGIN()
    FRAME_FMT_DATA(GLdouble, equation)
  FRAME_FMT_END()
...
EXDL_API(egl_pixelMapfv)
{
  ...
  STACK_FMT_BEGIN()
    STACK_FMT_DATA(GLenum,   map)
    STACK_FMT_DATA(GLsizei,  mapsize)
...
EXDL_API(egl_prioritizeTextures)
{
  ...
  STACK_FMT_BEGIN()
    STACK_FMT_DATA(GLsizei,   n)
    STACK_FMT_LPTR(GLuint*,   textures)
...
EXDL_API(egl_rectsv)
{
  ...
  STACK_FMT_BEGIN()
    STACK_FMT_LPTR(GLshort*, v1)
    STACK_FMT_DATA(GLshort,  v2[])
  STACK_FMT_END()
